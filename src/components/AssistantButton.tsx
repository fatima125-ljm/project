...
export function AssistantButton() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-24 end-5 z-50 flex h-[28rem] w-[22rem] max-w-[calc(100vw-2.5rem)] flex-col overflow-hidden rounded-3xl border border-border bg-card shadow-2xl animate-scale-in">
